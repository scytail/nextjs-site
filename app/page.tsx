...
export default function Home() {
  ...
  function selectViewedContent(viewedContent: string) {
    setViewedContent(viewedContent);
  }
      ...
      <div id='left' className='flex basis-1/4 flex-col items-start mx-5'>
        ...
        <ul id='nav'>
          ...
          <li className='text-stone-500'>
            <button onClick={() => setViewedContent("experience")} className={"group flex items-center hover:font-bold hover:text-white duration-200".concat(" ", viewedContent === "experience"? "text-orange-500":"")}>
              <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
              Experience
            </button>
          </li>
          <li className='text-stone-500'>
            <button onClick={() => setViewedContent("projects")} className={"group flex items-center hover:font-bold hover:text-white duration-200".concat(" ", viewedContent === "projects"? "text-orange-500":"")}>
              <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
              Projects
            </button>
          </li>
        ...
        <div id='links' className="flex flex-row mt-10 space-x-4 self-center">
          ...
          <a href='https://github.com/scytail' target="_blank">
            <svg className='ease-in-out duration-300 w-[1.54rem] h-6 fill-neutral-500 hover:fill-orange-500' xmlns="http://www.w3.org/2000/svg" role="link">
          ...
          <a href='https://www.linkedin.com/in/ben-schwabe/' target="_blank">
            <svg className="ease-in-out duration-300 w-6 h-6 fill-neutral-500 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" role='link'>
