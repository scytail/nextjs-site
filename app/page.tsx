  ...
  return (
    <div id='page' className='flex min-h-screen max-h-screen items-center flex-row bg-stone-800 px-5 font-sans'>
      <div id='left' className='basis-1/4 flex-col items-center'>
        <svg id='logo' className="hover:stroke-orange-500 w-1/2 fill-neutral-500" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600.000000 600.000000" preserveAspectRatio="xMidYMid meet" role="img">
        ...
        <ul id='nav'>
          <li className='text-stone-500 hover:font-bold hover:text-white'><a href='#about'>About</a></li>
          <li className='text-stone-500 hover:font-bold hover:text-white'><a href='#experience'>Experience</a></li>
          <li className='text-stone-500 hover:font-bold hover:text-white'><a href='#projects'>Projects</a></li>
        </ul>
        <div id='contact' className="flex flex-row mt-10 space-x-4">
          <a href='#contactForm'>
            <svg className='w-6 h-6 stroke-neutral-500 hover:stroke-orange-500' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} role="link">
          ...
          <a href='https://github.com/scytail' target="_blank">
            <svg className='w-7 h-6 fill-neutral-500 hover:fill-orange-500' xmlns="http://www.w3.org/2000/svg" role="link">
          ...
          <a href='https://www.linkedin.com/in/ben-schwabe/' target="_blank">
            <svg className="w-6 h-6 fill-neutral-500 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" role='link'>
      ...
      <div id='center' className='border-2 flex flex-col relative basis-3/4 min-h-screen text-right'>
        ...
        <div id='footer' className='absolute bottom-0 right-0 text-stone-500'>
