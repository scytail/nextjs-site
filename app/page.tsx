      ...
      <div id='left' className='basis-1/4 flex-col items-center'>
        ...
        <ul id='nav'>
          <li className='text-stone-500'>
            <a href='#about' className="group flex items-center hover:font-bold hover:text-white duration-200">
              <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
              About
            </a>
          </li>
          <li className='text-stone-500 hover:font-bold hover:text-white'>
            <a href='#experience' className="group flex items-center hover:font-bold hover:text-white duration-200">
              <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
              Experience
            </a>
          </li>
          <li className='text-stone-500 hover:font-bold hover:text-white'>
            <a href='#projects' className="group flex items-center hover:font-bold hover:text-white duration-200">
              <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
              Projects
            </a>
          </li>
        ...
        <div id='contact' className="flex flex-row mt-10 space-x-4">
          ...
          <a href='https://github.com/scytail' target="_blank">
            <svg className='ease-in-out duration-300 w-7 h-6 fill-neutral-500 hover:fill-orange-500' xmlns="http://www.w3.org/2000/svg" role="link">
