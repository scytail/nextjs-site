      ...
      <div className="text-white flex-wrap">
        <div className="grid grid-cols-2 gap-5 my-5">
          <a href="https://github.com/scytail/Manageable" className="flex flex-col border-2 border-slate-500 rounded-xl p-2 hover:bg-slate-700/75 duration-100" target="_blank">
            ...
            <span className="grow text-base">A lightweight, python-based discord bot for managing discord servers of any size. Features include role management, useful moderation tools, a TTRPG-friendly dice roller, and user engagement activities.</span>
          ...
          <a href="https://github.com/scytail/nextjs-site" className="flex flex-col border-2 border-slate-500 rounded-xl p-2 hover:bg-slate-700/75 duration-100" target="_blank">
            ...
            <span className="grow text-base">You are here! Built from scratch using the NextJS framework and deployed on the Vercel network, this portfolio site boasts a snappy interface and a clean, cool design.</span>
            <div className="flex flex-row flex-wrap gap-1 mt-2">
          ...
          <a href="https://github.com/scytail/Network-Mapper" className="flex flex-col border-2 border-slate-500 rounded-xl p-2 hover:bg-slate-700/75 duration-100" target="_blank">
            ...
            <span className="grow text-base">A python script built to crawl firewall and network interfaces and generate a visual representation of the ecosystem.</span>
            <div className="flex flex-row flex-wrap gap-1 mt-2">
              <div className="bg-sky-500 text-slate-800 px-3 rounded-full">Python</div>
          ...
          <a href="https://github.com/scytail/LiteCrawl" className="flex flex-col border-2 border-slate-500 rounded-xl p-2 hover:bg-slate-700/75 duration-100" target="_blank">
            ...
            <span className="grow text-base">A Unity game inspired by Loren Schmidt&apos;s musings. Explore layers of a procedurally-generated dungeon while defeating enemies and survive as long as possible.</span>
            <div className="flex flex-row flex-wrap gap-1 mt-2">
