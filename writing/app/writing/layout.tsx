        ...
        <nav className='sticky top-0 bg-slate-200 shadow-md'>
          <div className='flex items-center justify-between px-6 py-4 max-w-6xl mx-auto'>
            <div className='flex items-center gap-8'>
              <svg id='logo' className="w-12 h-12 fill-neutral-500" strokeLinecap="round" strokeLinejoin="round" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600.000000 600.000000" preserveAspectRatio="xMidYMid meet" role="img">
            ...
            <a href='/' className='text-base text-gray-500 hover:text-gray-700 ease-in-out duration-200'>Back to Home</a>
          </div>
        </nav>
        {children}
        <ScrollButton />
