  ...
  return (
    <div>
      ...
      <div className="text-white flex-wrap mb-3">
        I am a passionate full-stack developer based in Saint Louis, Missouri. I take pleasure in learning new technologies, and view each project as a creative challenge.
        <br />
        <br />
