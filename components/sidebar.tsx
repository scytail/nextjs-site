    ...
    <div className="flex basis-1/4 flex-col items-start mx-5">
      <svg id='logo' className="self-center w-1/2 fill-neutral-500" strokeLinecap="round" strokeLinejoin="round" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600.000000 600.000000" preserveAspectRatio="xMidYMid meet" role="img">
        ...
        <div className='pl-10'>
          ...
          <ul id='nav'>
            <li className='text-base text-zinc-500'>
              <button onClick={() => navbarLinkClickHandler("about")} className={"group flex items-center hover:font-bold hover:text-white duration-200".concat(" ", viewedContent === "about"? "text-teal-500":"")}>
                <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
                About
              </button>
            </li>
            <li className='text-zinc-500'>
              <button onClick={() => navbarLinkClickHandler("experience")} className={"group flex items-center hover:font-bold hover:text-white duration-200".concat(" ", viewedContent === "experience"? "text-teal-500":"")}>
                <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
                Experience
              </button>
            </li>
            <li className='text-zinc-500'>
              <button onClick={() => navbarLinkClickHandler("projects")} className={"group flex items-center hover:font-bold hover:text-white duration-200".concat(" ", viewedContent === "projects"? "text-teal-500":"")}>
                <span className="h-px w-0 bg-white mr-4 group-hover:w-4 group-hover:mr-2 duration-200"></span>
                Projects
              </button>
            </li>
        ...
        <div id='links' className="flex flex-row mt-10 gap-x-4 self-center">
          ...
          */}
          <a href='mailto:scytaill@gmail.com'>
            <svg className='ease-in-out duration-300 w-6 h-6 stroke-neutral-500 hover:stroke-cyan-500' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} role="link">
